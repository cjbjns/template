 ...
 *
 * Remember to modify .vtable if needed.
 */
typedef enum IRQn {
    ...
    LVD_IRQn                  = 19,             /*!< Device Specific Interrupt #0 */

    I3C0_IRQn                 = 20,             /*!< Device Specific Interrupt #1 */
    SPI0_IRQn                 = 21,             /*!< Device Specific Interrupt #2 */
    I2C0_IRQn                 = 22,             /*!< Device Specific Interrupt #3 */
    CSX_IRQn                  = 23,             /*!< Device Specific Interrupt #4 */

    SLP_IRQn                  = 24,             /*!< Device Specific Interrupt #5 */
    GPIO_IRQn          		  = 25,             /*!< Device Specific Interrupt #6 */
    VC3_IRQn          		  = 26,             /*!< Device Specific Interrupt #7 */
    DMA_IRQn          		  = 27,             /*!< Device Specific Interrupt #8 */

    UART0_IRQn          	  = 28,             /*!< Device Specific Interrupt #9 */
    DSP_IRQn         		  = 29,             /*!< Device Specific Interrupt #10 */
    TIM16_IRQn                = 30,             /*!< Device Specific Interrupt #11 */
    QSPI_IRQn                 = 31,             /*!< Device Specific Interrupt #12 */
